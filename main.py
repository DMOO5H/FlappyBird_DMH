...
game_images = {}
framepersecond = 32
pipeimage = 'Drive_Algo_and_Pro_Final_Project_Images/pipe.png'
background_image = 'Drive_Algo_and_Pro_Final_Project_Images/background.jpg'
birdplayer_image = 'Drive_Algo_and_Pro_Final_Project_Images/bird.png'
sealevel_image = 'Drive_Algo_and_Pro_Final_Project_Images/base.jfif'
...
if __name__ == "__main__":
    ...
    game_images['scoreimages'] = (
        pygame.image.load('Drive_Algo_and_Pro_Final_Project_Images/0.png').convert_alpha(),
        pygame.image.load('Drive_Algo_and_Pro_Final_Project_Images/1.png').convert_alpha(),
        pygame.image.load('Drive_Algo_and_Pro_Final_Project_Images/2.png').convert_alpha(),
        pygame.image.load('Drive_Algo_and_Pro_Final_Project_Images/3.png').convert_alpha(),
        pygame.image.load('Drive_Algo_and_Pro_Final_Project_Images/4.png').convert_alpha(),
        pygame.image.load('Drive_Algo_and_Pro_Final_Project_Images/5.png').convert_alpha(),
        pygame.image.load('Drive_Algo_and_Pro_Final_Project_Images/6.png').convert_alpha(),
        pygame.image.load('Drive_Algo_and_Pro_Final_Project_Images/7.png').convert_alpha(),
        pygame.image.load('Drive_Algo_and_Pro_Final_Project_Images/8.png').convert_alpha(),
        pygame.image.load('Drive_Algo_and_Pro_Final_Project_Images/9.png').convert_alpha()
    )
